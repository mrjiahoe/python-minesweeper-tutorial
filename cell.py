...
class Cell:
    ...
    def left_click_actions(self, event):
        if self.is_mine:
            ...
            if self.surrounded_cells_mines_length == 0:  # if nearby cell has 0 mines, show number of mines of nearby cell
            ...
            if Cell.cell_count == settings.MINES_COUNT:
                ctypes.windll.user32.MessageBoxW(
                    0, 'Congratulations! You\'ve won the game!', 'Game Over',
                    0)
        ...
        if not self.is_opened:
            ...
            if Cell.cell_count_label_object:
                Cell.cell_count_label_object.configure(
                    text=f"Cells Left:{Cell.cell_count}")
            # If this is a mine candidate, then for safety, we should configure the background to SystemButtonFace
